...
class Pooling:
    def __init__(self, input_shape, filter_size, stride=(1, 1), pooling='max', layer_before=None, next_layer=None,
                 trainings_mode=True):
        """
        ...
        # self.Cache = np.zeros((self.out_neurons, self.out_width, self.out_height, 3), dtype='int32')
    ...
    def save(self):
        # input_shape, filter_size, stride = 1, pooling = 'max'
